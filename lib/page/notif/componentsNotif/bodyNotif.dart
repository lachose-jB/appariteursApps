...
class _BodyNotifState extends State<BodyNotif> {
  final topNavBar = TopNavBar(onNotificationPressed: () {}, PageName: "My Page");

  @override
  Widget build(BuildContext context) {
    double _w = MediaQuery.of(context).size.width;

    int itemCount = topNavBar.notificationCount; // Use the getter method to get the notification count
